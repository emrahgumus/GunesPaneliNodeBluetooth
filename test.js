...
var socket = require('socket.io-client')('http://192.168.1.102:4000');
...
SensorTag.discover(function(sensorTag) {
  ...
  async.series([
    ...
    var veriler = {panelId: '583fe76c9496e36605f923b9', akim: objectTemperature.toFixed(1), gerilim: '', light: '', sicaklik: '', nem: ''};
